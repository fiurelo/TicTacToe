...
public class PvAI extends javax.swing.JFrame implements ActionListener {
    ...
    private void inizializzaBottoni() {
        ...
        for (i = 0; i < 3; i++) {
            for (j = 0; j < 3; j++) {
                ...
                button[i][j].setBackground(new java.awt.Color(80,80,80));
    ...
    public void cpuMove() {
        ...
        if (staVincendo() == 1) {
            vittorieGiocatore1++;
            if (JOptionPane.showConfirmDialog(frame, "Player X vince! Vuoi giocare di nuovo?\nVittorie giocatore 1: " + vittorieGiocatore1 + "\nVittorie giocatore 2: " + vittorieGiocatore2, "Tic Tac Toe",
            ...
            vittorieGiocatore2++;
            if (JOptionPane.showConfirmDialog(frame, "Player O vince! Vuoi giocare di nuovo?\nVittorie giocatore 1: " + vittorieGiocatore1 + "\nVittorie giocatore 2: " + vittorieGiocatore2, "Tic Tac Toe",
                    JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION) {
                resetGame();
            } else {
                this.dispose();
